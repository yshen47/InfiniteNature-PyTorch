...
# A dummy class to collect all bunch of infiniate_nature_data
class CArgs(object):
    pass
...
def writeResultPointCloud(predictionNp, predictionSemantic, accuracyMask, observedMask, visualizeIdx, maxNumPoint=10000):
    ...
    layout = go.Layout(scene=dict(aspectmode="infiniate_nature_data"))
    ...
    plotlyStr = plotly.offline.plot({"infiniate_nature_data": data, "layout": layout}, include_plotlyjs=False, output_type='div')
