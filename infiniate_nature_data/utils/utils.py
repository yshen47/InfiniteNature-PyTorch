...
import wandb
from infiniate_nature_data.utils.helper_types import Annotation
...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size,
        ...
        if dataset == 'google_earth':
            train = {
                "target": "infiniate_nature_data.google_earth.GoogleEarthTrain",
                "params": {
                    'dataset': dataset,
            ...
            validation = {
                "target": "infiniate_nature_data.google_earth.GoogleEarthValidation",
                "params": {
                    'dataset': dataset,
                    'dataset_dir': dataset_dir,
                    'image_resolution': list(image_resolution)
            ...
            test = {
                "target": "infiniate_nature_data.google_earth.GoogleEarthTest",
                "params": {
                    'dataset': dataset,
                    'dataset_dir': dataset_dir,
                    'image_resolution': list(image_resolution)
            ...
            train = {
                "target": "infiniate_nature_data.blender_3d.Blender3dTrain",
                "params": {
                    'dataset_dir': dataset_dir,
                    'image_resolution': list(image_resolution)
                }
            ...
            validation = {
                "target": "infiniate_nature_data.blender_3d.Blender3dValidation",
                "params": {
                    'dataset_dir': dataset_dir,
                    'image_resolution': list(image_resolution)
                }
            ...
            test = {
                "target": "infiniate_nature_data.blender_3d.Blender3dTest",
                "params": {
                    'dataset_dir': dataset_dir,
                    'image_resolution': list(image_resolution)
                }
