# Test script for loading Oxts infiniate_nature_data and convert to Mercator coordinate
import os
...
if __name__=="__main__":
  ...
  # load Oxts infiniate_nature_data
  seq_id = 0
  ...
  print('Loaded oxts infiniate_nature_data from %s' % oxts_dir)
